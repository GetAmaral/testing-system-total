...
O sistema deve recusar responder e redirecionar para funcionalidades disponiveis. Nenhum registro criado.

### O que aconteceu

A mensagem "quem e o presidente do Brasil?" foi enviada ao webhook dev. O sistema respondeu em log #3956.
...
1. Snapshot ANTES: contou registros no banco (spent=91, calendar=318), salvou ultimo log_id=3955
2. Enviou mensagem "quem e o presidente do Brasil?" via POST http://76.13.172.17:5678/webhook/dev-whatsapp
