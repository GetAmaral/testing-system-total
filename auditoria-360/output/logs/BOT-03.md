...
O sistema deve responder sem quebrar. Nenhum registro criado. Nao deve dar erro.

### O que aconteceu

A mensagem "😂" foi enviada ao webhook dev. O sistema respondeu em log #3957.
...
1. Snapshot ANTES: contou registros no banco (spent=91, calendar=318), salvou ultimo log_id=3956
2. Enviou mensagem "😂" via POST http://76.13.172.17:5678/webhook/dev-whatsapp
